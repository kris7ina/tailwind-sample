    ...
    <div className='w-full pb-[8rem] pt-[5rem] px-4 bg-white'>
      ...
      <div className='max-w-[1040px] mx-auto grid lg:grid-cols-3 gap-8 px-4'>
        ...
        <div className='w-full mx-auto max-w-[400px] shadow-xl shadow-cyan-800/10 flex flex-col p-4 my-8 rounded-lg hover:scale-105 duration-300'>
          ...
          <button className='bg-[#00df9a] w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3 text-white hover:bg-[#4efac4] duration-300'>Start Trial</button>
          <p className='text-center text-sm text-gray-400 pb-2'>30-day money-back guarantee.</p>
        </div>
        
        <div className='w-full mx-auto max-w-[400px] shadow-xl shadow-cyan-800/10 flex flex-col p-4 my-8 md:my-3 rounded-lg hover:scale-105 duration-300 bg-slate-100'>
          ...
          <button className='bg-black w-[200px] rounded-md font-medium my-6 mx-auto px-6 py-3 text-white md:scale-110 md:mt-12 hover:bg-[#353535] duration-300'>Start Trial</button>
