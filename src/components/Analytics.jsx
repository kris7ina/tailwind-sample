    ...
    <div className='bg-white w-full py-16 px-8'>
      <div className='max-w-[1040px] mx-auto grid md:grid-cols-2'>
        ...
        <div className='flex flex-col justify-center'>
          ...
          <button className='bg-[#00df9a] w-[200px] rounded-xl font-medium my-6 mx-auto md:mx-0 px-6 py-3 text-white hover:scale-105 hover:bg-[#4efac4] duration-300'>Get Started</button>
        </div>
      </div>
    </div>
  )
